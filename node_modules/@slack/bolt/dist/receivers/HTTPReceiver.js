 ...
 */
class HTTPReceiver {
    constructor({ signingSecret = '', endpoints = ['/slack/events'], customRoutes = [], logger = undefined, logLevel = logger_1.LogLevel.INFO, processBeforeResponse = false, signatureVerification = true, clientId = undefined, clientSecret = undefined, stateSecret = undefined, redirectUri = undefined, installationStore = undefined, scopes = undefined, installerOptions = {}, }) {
        var _a, _b, _c;
    ...
    start(portOrListenOptions, serverOptions = {}) {
        ...
        this.server = createServerFn(serverOptions, (req, res) => {
            try {
                ...
                const e = error;
                if (e.code === errors_1.ErrorCode.HTTPReceiverDeferredRequestError) {
