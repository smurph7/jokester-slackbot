...
export default class SocketModeReceiver implements Receiver {
    ...
    private routes;
    constructor({ appToken, logger, logLevel, clientId, clientSecret, stateSecret, redirectUri, installationStore, scopes, installerOptions, customRoutes, }: SocketModeReceiverOptions);
    init(app: App): void;
